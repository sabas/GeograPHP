...
use GeograPHP\Parser\EWKTTokenizer;
use GeograPHP\Parser\EWKTFormatError;
...
class EWKTParserTest extends \PHPUnit\Framework\TestCase
{
    protected $parser;

    protected function setUp(): void
    {
        $this->parser = new EWKTParser();
    }

    public function test_tokenizer()
    {
        $t = new EWKTTokenizer("MULTIPOINT(5.5  6, 0 -7.88 ) ");
    ...
    {
        $this->expectException('GeograPHP\Parser\EWKTFormatError');
