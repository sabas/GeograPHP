...
namespace GeograPHP\Parser\EWKB;
...
class Parser
{
     ...
     {
         $this->unpacker = new Unpacker($ewkb);
         $this->srid = null;
         $this->with_z = null;
         $this->with_m = null;
     ...
     private function parse_geometry()
     {
         ...
         if (isset($this->type_map[$type])) {
             ...
             throw new FormatError("Invalid geometry type");
         }
     }
     ...
     private function parse_multi_geometries($type)
     {
         ...
         return call_user_func(array('GeograPHP\\Geometry\\' . $type, 'from_geometries'), $geoms, $this->srid, $this->with_z, $this->with_m);
     }
